...
if (Crises.find().count() === 0) {
  Crises.insert({
    name: 'Tsunami',
    media: ['http://images.nationalgeographic.com/wpf/media-live/photos/000/332/cache/japan-earthquake-tsunami-nuclear-unforgettable-pictures-wave_33291_600x450.jpg','http://i.dailymail.co.uk/i/pix/2011/03/15/article-0-0B2D7C2600000578-689_964x641.jpg']
  });
  ...
  Crises.insert({
    ...
    media: ['http://www.codinghorror.com/blog/2009/12/our-disaster-recovery-plan.png', 'http://ctmalaga.com.au/wp-content/uploads/2013/01/Lostdata-448x205.jpg']
  });
